module.exports = async function (){
  ...
  _g.gasVals = {gasLimit: 4512388, gasPrice: parseUnits('5.0', 'gwei')};
  ...
  let _addr = {
    ropsten: {
      ...
      MockyToken: "0x4c15FAd8dbD839eC793727b18b50A336E63a9370",
      ref_MockyTokenUniLocked: "0x29635f6f3740903dfa4243F7eE222292f7c3501d",
      FTPLiqLock: "0x3Fcc7d2decE3750427Aa2a6454c1f1FE6d7B1c92",
      UniLiqLock: "0xdBc5b192652178e2f35f48583241d9b50C8d8FB9",
      USDC: "0x0f49170b7b516fea8f0f26f0fab1748dd69776be",
      ref__deployer: "0x1eE134E4Fccd51aEbB0B2d1e475ae4f57d41ac70",
      ref__MockyPair: "0x5aC81813F5eF63eE6fE5D380d6f9d338FBF38F85",
    ...
    mainnet:{
      ...
      usdcWethPool: "0x8ad599c3A0ff1De082011EFDDc58f1908eb6e6D8",
    },
    bsc:{
  ...
  let _i = {};
  //-------ESTABLISH TOKEN--------//
  _i.mocky = await ethers.getContractAt("MockyToken", _addr.MockyToken)
  ...
  async function _deployNew(opts) {
    ...
    appendToLog({[`New ${opts.artifact} Deployment`]: inst.address, 'owner':rcpt.from})
    await _sleep(3000);
    return inst;
  }
...
// });
  ...
  log3('_addr.MockyPair: ',_addr.MockyPair);
